        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                @if (Auth::user()->role_id == 28)
                    <div>
                        <a class="btn btn-primary" style="width:17%; margin-left:25px" style="color: white"
                            href="{{ route('appeal.causeList.case.entry.from') }}">এন্ট্রি করুন </a>
                    </div>
                @endif
                    ...
                    <table class="table table-hover mb-6 font-size-h5">
                        <thead class="thead-customStyle2 font-size-h6">
                            <tr style="text-align: justify">
                                ...
                                <th scope="col">১ম পক্ষ</th>
                                <th scope="col">২য় পক্ষ</th>
                                <th scope="col">সর্বশেষ আদেশের তারিখ</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($results as $key => $row)
                                <tr>
                                    ...
                                    {{-- @dd($row) --}}
                                    <td>{{ $row->caseNo }}</td>
                                    <td>{{ en2bn($row->caseDate) }}</td>
                                    <td>{{ $row->applicantName }}</td>
                                    <td>{{ $row->defaulterName }}</td>
                                        ...
                                        <div class="btn-group float-right">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item"
                                                    href="{{ route('appeal.causelist.case.details', encrypt($row->id)) }}">বিস্তারিত
                                                    তথ্য</a>
                                                <a class="dropdown-item" style="cursor: pointer"
                                                    onclick="edit_causelist(<?php echo $row->id; ?>)">
                                                    আপডেট করুন
                                                </a>
