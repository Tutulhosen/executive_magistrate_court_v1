@php
    ...
    if (Auth::check()) {
        ...
        if ($roleID != 1 && $roleID != 2 && $roleID != 8 && $roleID != 6 && $roleID != 7 && $roleID != 25 && $roleID != 27 && $roleID != 28 && $roleID != 32 && $roleID != 33 && $roleID != 34 && $roleID != 36 && $roleID != 37 && $roleID != 38 && $roleID != 39 && $roleID != 20) {
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi navi-hover py-4">
                                    ...
                                    @if (in_array(46, $menu) || globalUserInfo()->role_id == 28)
                                    <!-- <li class="navi-item">
