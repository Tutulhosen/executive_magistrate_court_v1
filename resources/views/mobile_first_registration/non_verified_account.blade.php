...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <h1 class="py-5">আপনার প্রোফাইলটি জাতীয় পরিচয়পত্র দ্বারা ভেরিফাইড নয়, জাতীয় পরিচয়পত্র দ্বারা ভেরিফাইড  না
                হলে কোন কার্যক্রমে অংশগ্রহণ করা যাবেনা।</h1>
            <h2>ভেরিফাই  করতে নিচের বাটনে ক্লিক করুন</h2>
            <button class="btn btn-primary nid_verify_account">ভেরিফাই</button>
        </div>
    </div>
