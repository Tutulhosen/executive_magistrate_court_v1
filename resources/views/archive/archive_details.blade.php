            ...
            <table class="table table-striped border">
               ...
               <tbody>
                ...
                <tr>
                    ...
                    <td >{{ act_name_conveter($case_details->related_act) ?? '-'}}</td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                    ...
                    <td >{{ div_dis_upa_name_conveter($case_details->div_id)['div_name'] ?? '-'}}</td>
                 </tr>

                 <tr>
                    <th scope="row">জেলা</th>
                    <td >{{ div_dis_upa_name_conveter($case_details->div_id)['dis_name'] ?? '-'}}</td>
                 </tr>

                 <tr>
                    <th scope="row">উপজেলা/ থানা</th>
                    <td >{{ div_dis_upa_name_conveter($case_details->div_id)['upa_name'] ?? '-'}}</td>
                 </tr>
