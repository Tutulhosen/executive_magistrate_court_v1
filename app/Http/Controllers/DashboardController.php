    ...
    public function index()
    {
        ...
        if ($roleID == 1) {
           ...
           // $data['total_mouja'] = DB::table('mouja')->count();
            ...
            ->select('em_appeals.appeal_status','em_appeals.next_date','emc_manual_causelist.case_no as caseno','emc_manual_causelist.appeal_id as appealid',
            'emc_manual_causelist.type','emc_manual_causelist.causelist_id','emc_manual_causelist.division_id',
            'emc_manual_causelist.district_id','emc_manual_causelist.court_id','emc_manual_causelist.next_date', 'custom_causelist.applicantName','custom_causelist.defaulterName')
            ->where('emc_manual_causelist.court_id', globalUserInfo()->court_id);

            $data['appeal']=$causelistdata->orderBy('emc_manual_causelist.id','desc')->paginate(10)->withQueryString();
