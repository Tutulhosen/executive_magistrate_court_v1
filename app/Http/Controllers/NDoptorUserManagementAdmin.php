...
class NDoptorUserManagementAdmin extends Controller
{
    public function all_user_list_from_doptor_segmented($office_id)
    {
        ...
        if ($get_token_response['status'] == 'success') {
            ...
            // 1dd('comne',$response_after_decode, $token, $office_id);
            ...
            if ($response_after_decode['status'] == 'success') {
                ...
                if ($doptor_office_status_from_db->office_layer_id == 21 && $doptor_office_status_from_db->office_origin_id == 15) {
                    ...
                    $data['page_title'] = 'এক্সিকিউটিভ ম্যাজিস্ট্রেট কোর্টের ইউজার ম্যানেজমেন্ট,  ' . $division_details->division_name_bng . ' বিভাগীয় ম্যাজিস্ট্রেসি';
                    ...
                    $data['page_title'] = 'এক্সিকিউটিভ ম্যাজিস্ট্রেট কোর্টের ইউজার ম্যানেজমেন্ট,  ' . $district_name_bng . ' জেলা ম্যাজিস্ট্রেসি';
                    $data['list_of_all'] = $list_of_all;
                    $data['office_id'] = $office_id;
                    ...
                    $data['page_title'] = 'এক্সিকিউটিভ ম্যাজিস্ট্রেট কোর্টের ইউজার ম্যানেজমেন্ট,  ' . $upazila_name_bn . ' উপজেলা ম্যাজিস্ট্রেসি ';
                    $data['list_of_all'] = $list_of_all;
                    $data['office_id'] = $office_id;
