                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" name="appeal_status">
                            <option value="ON_TRIAL" <?php if ($lastorder->appeal_status == 'ON_TRIAL') {
                                echo 'Selected';
                            } ?>>চলমান</option>
                            <option value="CLOSED" <?php if ($lastorder->appeal_status == 'CLOSED') {
                                echo 'Selected';
                            } ?>>নিষ্পন্ন</option>
                        </select>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="next_date" id="next_date"
                            ...
                            value="{{ $classEditdata->next_date }}" placeholder="সাল/মাস/দিন" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="lastorderDate" id="lastorderDate"
                            class="form-control form-control-sm common_datepicker"
                            value="{{ $classEditdata->lastorderDate }}" placeholder="সাল/মাস/দিন" autocomplete="off">
                    </div>
                </div>
            </div>
