        ...
        <div class="priview-header">
            <div class="row">
                ...
                <div class="col-6 text-center float-left" style="border: 0px solid red;">
                    <p class="text-center" style="margin-top: 0;"><span style="font-size:25px;font-weight: bold;">এক্সিকিউটিভ কোর্ট</span><br> <!-- <span style="font-size:small">মন্ত্রিপরিষদ বিভাগ, বাংলাদেশ সচিবালয়, ঢাকা</span> --></p>
        ...
        <div class="priview-memorandum">
            <div class="row">
                <div class="col-12 text-center">
                    <div style="font-size:18px;"><u><?= $report_name ?> বিভিন্ন আদালতের মামলা সংক্রান্ত তথ্য</u></div>
                    <?php //!empty($data_status)?'ব্যাক্তিগত ডাটার স্ট্যাটাসঃ '.func_datasheet_status($data_status).'<br>':''
