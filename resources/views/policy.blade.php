                ...
                <div id="accordion" style="width: 100%;">
                    ...
                    <div class="card" >
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            আমাদের ওয়েবসাইট emc.ecourt.gov.bd এর মাধ্যমে আমরা মামলা ব্যবস্থাপনা সিস্টেম পরিচালনা করছি, এবং এটির মাধ্যমে আমরা কীভাবে আমাদের পরিষেবা ব্যবহার করছি, সে সম্পর্কে ব্যাখ্যা দেওয়া হয়েছে। আমাদের গোপনীয়তা নীতি emctraining.ecourt.gov.bd  আপনার পরিদর্শন অনুভব করে এবং তার মাধ্যমে আমরা কোনও তথ্য সংগ্রহ, রক্ষণ, এবং প্রকাশ করি তা ব্যাখ্যা করে। আমরা আপনার ডেটা ব্যবহার করে পরিষেবা প্রদান এবং তাকে আরও উন্নত করতে পারি। আপনি যদি এই পরিষেবা ব্যবহার করতে সম্মত হন, তবে আপনি এই নীতির মাধ্যমে তথ্য সংগ্রহ এবং ব্যবহার করতে সম্মত হয়েছেন। এই গোপনীয়তা নীতি অনুসারে, এই শর্তাবলি যত্ন নেওয়া হয়েছে এবং এটির মাধ্যমে আমাদের প্রয়োজনীয় নিরাপত্তা ও বিধি মেনে চলা হয়েছে।
                    ...
                    <div class="card" >
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="card-body">
                            গণপ্রজাতন্ত্রী বাংলাদেশ সরকারের জেনারেল সার্টিফিকেট আদালত ব্যবস্থার অনলাইন প্ল্যাটফর্মটি  emc.ecourt.gov.bd ওয়েবসাইট দ্বারা পরিচালিত। সিস্টেমটির মাধ্যমে প্রতিষ্ঠান মামলার আবেদন করতে পারবে, আপীল করতে পারবে এবং আপীলের সর্বশেষ অবস্থা সম্পর্কে জানতে পারবে। পাশাপাশি প্রতিষ্ঠান মামলা দাখিল করার পর মামলার সর্বশেষ অবস্থা সম্পর্কে সিস্টেম কর্তৃক স্বয়ংক্রিয়ভাবে SMS ও ই-মেইলের মাধ্যমে জানানো হবে। প্রতিষ্টানের ও জনগণের সময় ও শ্রম লাঘবকল্পে একটি ইলেক্ট্রনিক সিস্টেমের মাধ্যমে তাদেরকে মামলার নকল সরবরাহ ও সেবা প্রদানের বিষয়ে গুরুত্বপূর্ণ ভূমিকা রাখবে।
                        </div>
                      </div>
                    </div>
