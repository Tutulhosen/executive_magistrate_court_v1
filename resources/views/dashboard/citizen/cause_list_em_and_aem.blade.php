                ...
                @forelse($appeal as $key=>$value)
                    ...
                    if ($value->type == 1) {
                        $data = DB::table('em_appeal_citizens')
                            ...
                            ->where('em_appeal_citizens.appeal_id', $value->appealid)
                        ...
                        $nodedata = DB::table('em_notes_modified')
                            ...
                            ->where('em_notes_modified.appeal_id', $value->appealid)
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">{{ en2bn($value->caseno) }}</td>
                            @if ($value->type == 1)
                            ...
                            @else
                                <td class="text-center">
                                    {{ isset($value->applicantName) ? $value->applicantName : '-' }}
                                    <br> <b>vs</b><br>
                                    {{ isset($value->defaulterName) ? $value->defaulterName : '-' }}
                                </td>
                            @endif
